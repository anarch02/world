                    ...
                    <div class="post-content-area mb-100">
                        ...
                        <div class="world-catagory-area">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="tab1" data-toggle="tab" href="#world-tab-all" role="tab" aria-controls="world-tab-all" aria-selected="true">All</a>
                                </li>

                                @foreach($categories as $category)
                                    <li class="nav-item">
                                        <a class="nav-link" id="tab{{ $category->id }}" data-toggle="tab" href="#world-tab-{{ $category->id }}" role="tab" aria-controls="world-tab-{{ $category->id }}" aria-selected="false">{{ $category->name }}</a>
                                    </li>
                                @endforeach
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="world-tab-all" role="tabpanel" aria-labelledby="tab1">
                                    @foreach($articles as $article)
                                        <!-- Single Blog Post -->
                                        <div class="single-blog-post post-style-4 d-flex align-items-center">
                                            <!-- Post Thumbnail -->
                                            <div class="post-thumbnail">
                                                <img src="{{ asset('img/blog-img/'.$article->image) }}" alt="{{ $article->title }}">
                                            </div>
                                            <!-- Post Content -->
                                            <div class="post-content">
                                                <a href="{{ route('article', $article->slug) }}" class="headline">
                                                    <h5>{{ $article->title }}</h5>
                                                </a>
                                ...
                                @foreach($categories as $category)
                                    <div class="tab-pane fade" id="world-tab-{{ $category->id }}" role="tabpanel" aria-labelledby="tab{{ $category->id }}">
